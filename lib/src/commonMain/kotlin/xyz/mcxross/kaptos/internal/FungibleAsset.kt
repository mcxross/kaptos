...
internal suspend fun getCurrentFungibleAssetBalances(
  ...
  page: PaginationArgs?,
): Result<GetCurrentFungibleAssetBalancesQuery.Data?, AptosIndexerError> = handleQuery {
...
internal suspend fun getFungibleAssetActivities(
  ...
  page: PaginationArgs?,
): Result<GetFungibleAssetActivitiesQuery.Data?, AptosIndexerError> = handleQuery {
  getGraphqlClient(config)
    .query(
...
internal suspend fun getFungibleAssetMetadata(
  ...
  page: PaginationArgs?,
): Result<GetFungibleAssetMetadataQuery.Data?, AptosIndexerError> = handleQuery {
  getGraphqlClient(config)
    .query(
