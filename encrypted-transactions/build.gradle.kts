...
kotlin {
  ...
  android {
    namespace = "xyz.mcxross.kaptos.encrypted"
    compileSdk {
...
dokka {
  moduleName.set("Kaptos Encrypted Transactions")
...
mavenPublishing {
  ...
  pom {
    name.set("Kaptos Encrypted Transactions")
    description.set("Aptos batch-encrypted transaction construction for Kaptos")
